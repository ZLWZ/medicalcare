<template>
  <div class="storehouse">
    ...
    <!--表格数据展示-->
    <el-table :data="tableData"  v-loading="loading" style="width: 100%; margin-top: 20px;" :border="true" >
      ...
      <el-table-column prop="dmoney" label="单价" width="120"></el-table-column>
      <el-table-column prop="zmoney" label="单价" width="120"></el-table-column>
...
<script>
  export default {
    ...
    methods: {
      ...
      selectPage(){
        this.loading = true;
        this.$axios.post("/api/waste/selWaste",{
          name : this.name, //商品名称
          sid : this.sid, //规格id
          did : this.did, //剂型id
          cid : this.cid, //厂家id
